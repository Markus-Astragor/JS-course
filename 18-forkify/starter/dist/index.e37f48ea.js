...
var _resultsViewsJs = require("./views/resultsViews.js");
var _resultsViewsJsDefault = parcelHelpers.interopDefault(_resultsViewsJs);
...
const controlSearch = async ()=>{
    try {
        (0, _resultsViewsJsDefault.default).showSpinner();
        const query = (0, _searchViewJsDefault.default).getQuery();
        if (!query) return;
        await _modelJs.loadSearch(query);
        // Rendering results
        (0, _resultsViewsJsDefault.default).render(_modelJs.getSearchResultsPage(1));
        // Render pagination
...
const paginationController = (page)=>{
    (0, _resultsViewsJsDefault.default).render(_modelJs.getSearchResultsPage(page));
    (0, _paginationViewJsDefault.default).render(_modelJs.state.search);
};
...
const controlAddRecipe = async (newRecipe)=>{
    try {
        ...
        window.history.pushState(null, "", `#${_modelJs.state.recipe.id}`) // it allows us to change url without reloading the page
        ;
        setTimeout(()=>{
...
const init = ()=>{
    (0, _bookMarkViewJsDefault.default).handleRender(controlBookmarks);
    ...
    (0, _addRecipeViewJsDefault.default).handleSubmit(controlAddRecipe);
};
init();

},{"core-js/modules/web.immediate.js":"49tUX","./model.js":"Y4A21","./config.js":"k5Hzs","./views/recipeView.js":"l60JC","./views/resultsViews.js":"4tKYq","./views/searchView.js":"9OQAM","./views/paginationView.js":"6z7bi","./views/bookMarkView.js":"jpgVd","./views/addRecipeView.js":"i6DNj","regenerator-runtime/runtime":"dXNgZ","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"49tUX":[function(require,module,exports) {
"use strict";
...
const loadRecipe = async (id)=>{
    try {
        ...
        const responseData = await (0, _helpersJs.AJAX)(`${(0, _configJs.API_URL)}${id}?key=${(0, _configJs.API_KEY)}`);
...
const loadSearch = async (query)=>{
    try {
        ...
        const responseData = await (0, _helpersJs.AJAX)(`${(0, _configJs.API_URL)}?search=${query}&key=${(0, _configJs.API_KEY)}`);
...
const API_KEY = "dcd5ead4-5bce-495c-8638-2c12460fe637";
...
class RecipeView extends (0, _viewJsDefault.default) {
    ...
    _errorMessage = "We can't find such recipe with this id. Please try another one";
    _successMessage = "";
    handleRender(handler = this._errorMessage) {
        [
            "hashchange",
            "load"
    ...
    _generateMarkup() {
     ...
     <h1 class="recipe__title">
      ...
      <button class="btn--round btn--bookmark">
        <svg class="">
          <use href="${0, _iconsSvgDefault.default}#icon-bookmark${this._data.bookMarked ? "-fill" : this._data.bookMarked === false ? "" : ""}"></use>
        </svg>
      </button>
    </div>
...
},{"9bcc84ee5d265e38":"lgJ39"}],"4tKYq":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _viewJs = require("./View.js");
var _viewJsDefault = parcelHelpers.interopDefault(_viewJs);
...
},{"./View.js":"5cUXS","./previewView.js":"1FDQ6","../../img/icons.svg":"cMpiy","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"1FDQ6":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _viewJs = require("./View.js");
var _viewJsDefault = parcelHelpers.interopDefault(_viewJs);
...
},{"./View.js":"5cUXS","../../img/icons.svg":"cMpiy","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"9OQAM":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
class SearchView {
...
class PaginationView extends (0, _viewJsDefault.default) {
    ...
    _generateMarkup() {
      ...
      `;
        ...
        if (this._data.page > 1 && this._data.page < numPages) return `<button data-goto="${this._data.page - 1}" class="btn--inline pagination__btn--prev">
                  <svg class="search__icon">
                    <use href="${0, _iconsSvgDefault.default}#icon-arrow-left"></use>
                  </svg>
                  <span>Page ${this._data.page - 1}</span>
...
},{"./View.js":"5cUXS","../../img/icons.svg":"cMpiy","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"jpgVd":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _viewJs = require("./View.js");
var _viewJsDefault = parcelHelpers.interopDefault(_viewJs);
...
},{"./View.js":"5cUXS","../../img/icons.svg":"cMpiy","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"dXNgZ":[function(require,module,exports) {
/**
